...
func main() {
	...
	var (
		...
		dbDsn      = fs.String("dsn", "postgres://f1api_db_user:tQRnoQbmADuyebQZswTQivWzsBNlKkNa@dpg-cp3gipgl6cac73f570q0-a.singapore-postgres.render.com/f1api_db", "PostgreSQL DSN")
	)
